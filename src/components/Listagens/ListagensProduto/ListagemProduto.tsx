                            ...
                            {currentProdutos && currentProdutos.length > 0 ? (
                                currentProdutos.map((produto) => (
                                    <tr className="text-center md:text-left transition-colors hover:bg-slate-50 group" key={produto.idProduto}>
                                        ...
                                        <td className="p-3 md:p-4 hidden sm:table-cell text-slate-600">{produto.nome}</td>
                                        <td className="p-3 md:p-4 hidden sm:table-cell text-slate-600">{produto.preco_unitario}</td>
                                        <td className="p-3 md:p-4 hidden sm:table-cell text-slate-600">{produto.quantidade_disponivel}</td>
